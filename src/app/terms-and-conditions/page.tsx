const TermsAndConditions = () => {
    return (
        <div className="max-w-3xl mx-auto px-4 py-8">
            ...
            <p className="mb-4">For the purpose of these Terms and Conditions,The term &quot;we&quot;, &quot;us&quot;, &quot;our&quot; used anywhere on this page shall mean EMINDCAFE MENTAL HEALTH CARE PRIVATE LIMITED, whose registered/operational office is A/11, Sharddha Residency, Bitiset Agrawal Layout, Near Badere Photo Studio Devi Khadan, Hingna Fata Post Office Gandhi Nagar, Akola, Maharashtra 444001 Akola MAHARASHTRA 444001 . &quot;you&quot;, &ldquo;your&rdquo;, &quot;user&quot;, “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.</p>

            <p className="mb-4"><strong>Your use of the website and/or purchase from us are governed by following Terms and Conditions:</strong></p>
            <ul className="list-disc list-inside mb-4">
                ...
                <li className="mb-2">You may not create a link to our website from another website or document without EMINDCAFE MENTAL HEALTH CARE PRIVATE LIMITED&apos;s prior written consent.</li>
